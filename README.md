...
Для прогнозирования использовался подход временного ряда.

Основные этапы:

1. Подготовка данных:
   - агрегация данных до уровня день × точка;
   - формирование целевой переменной guests.
...
3. Обучение моделей:
   - baseline на основе недельной сезонности;
   - Ridge Regression;
   - CatBoost.
